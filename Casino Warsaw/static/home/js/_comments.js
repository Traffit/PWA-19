...
const reviews_data = [
  {
    ...
    comment: "Casino Warsaw to absolutna perełka! Doskonała oferta gier i świetne bonusy. Ocena 5/5!",
  },
  {
    img: "../../media/photos/comments/comment2.png",
    name: "Piotr Nowak",
    comment: "Jestem zachwycony Casino Warsaw! Grałem tu przez wiele godzin i nigdy się nie nudzi.",
  },
  {
    img: "../../media/photos/comments/comment3.png",
    name: "Krzysztof Wiśniewski",
    comment: "Casino Warsaw to najlepsze kasyno online, jakie znam! Wspaniała atmosfera i świetne wygrane.",
  },
  {
    img: "../../media/photos/comments/comment4.png",
    name: "Anna Nowakowska",
    comment: "Casino Warsaw to moje ulubione miejsce na rozrywkę online! Doskonała grafika i wciągające gry.",
  },
  {
    img: "../../media/photos/comments/comment5.png",
    name: "Magdalena Kowalczyk",
    comment: "Jestem pod wrażeniem aplikacji Casino Warsaw! Fantastyczna oferta gier i atrakcyjne promocje. Ocena 5/5!",
  },
];
  ...
  <div class="review">
          ...
          <div class="review__qna">
            ...
            <div class="review__true-false c-black">
              <a class="btn-true" aria-label="Yes">tak</a>
              <a class="btn-false" aria-label="No">nie</a>
            </div>
          </div>
        </div>
  `;
