...
const reviews_data = [
  {
    ...
    name: "Liam Smith",
    comment:
      "What could be better than indulging in candies and winning big? Olympus is my go-to for the sweetest victories!",
  },
  {
    img: "../../media/photos/comments/comment2.png",
    name: "Olivia Tremblay",
    comment:
      "I've been playing Olympus for weeks now — it's simply captivating! Consistent wins and loads of free spins. I absolutely adore this slot!",
  },
  {
    img: "../../media/photos/comments/comment3.png",
    name: "Noah MacKenzie",
    comment:
      "This game is a sugar rush of excitement! Olympus's vibrant colors and non-stop action make it an addictive delight.",
  },
  {
    img: "../../media/photos/comments/comment4.png",
    name: "Emma Gagnon",
    comment:
      "Olympus is a treat for the eyes and the wallet! I'm loving the constant thrill of tumbling wins and the free spins galore.",
  },
  {
    img: "../../media/photos/comments/comment5.png",
    name: "Lucas Leblanc",
    comment:
      "Can't get enough of the sweet-themed slot! Olympus is my guilty pleasure with its fantastic graphics and big win potential.",
  },
  {
    img: "../../media/photos/comments/comment6.png",
    name: "Ava Dubois",
    comment:
      "This game is like a candy store of winnings! Olympus's free spins never fail to bring in those delicious wins.",
  },
  {
    img: "../../media/photos/comments/comment7.png",
    name: "Ethan Roy",
    comment: "Absolutely addicted to Olympus! The thrill of consecutive wins with the tumble feature is unbeatable.",
  },
  {
    img: "../../media/photos/comments/comment8.png",
    name: "Charlotte Lefebvre",
    comment:
      "Olympus satisfies my craving for both sweets and wins. It's a fantastic blend of fun and potential big payouts.",
  },
  {
    img: "../../media/photos/comments/comment9.png",
    name: "Benjamin Beaulieu",
    comment:
      "Such a fun game! Olympus's free spins keep me coming back for more, and the visuals are simply delightful.",
  },
  {
    img: "../../media/photos/comments/comment10.png",
    name: "Sophia Caron",
    comment:
      "Olympus never disappoints! Love the adrenaline rush when those cascading wins keep rolling in. Highly recommended!",
  },
];
